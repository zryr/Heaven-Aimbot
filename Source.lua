...
function MainGUI:Create()
    ...
    local mainFrame = Instance.new("Frame", gui); mainFrame.Size = UDim2.new(0, 280, 0, 420); mainFrame.Position = UDim2.fromScale(0.15, 0.5); mainFrame.AnchorPoint = Vector2.new(0, 0.5); mainFrame.BackgroundColor3 = Config.bgColor; mainFrame.BorderSizePixel = 0; mainFrame.ClipsDescendants = false; mainFrame.Draggable = true
    ...
    dragFrame.Size = UDim2.new(1, 0, 0, 12); dragFrame.Position = UDim2.new(0,0,0,-12); dragFrame.BackgroundColor3 = Config.accentColor; dragFrame.BackgroundTransparency = 0; dragFrame.ZIndex = 10
    dragFrame.Active = true; dragFrame.Draggable = false
